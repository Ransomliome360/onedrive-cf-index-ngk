...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'RylondKuiperPienaar@outlook.co.nz',
  ...
  footer:
    'Powered by <a href="https://github.com/Ransomliome360/onedrive-cf-index-ngk" target="_blank" rel="noopener noreferrer">KKSc[d]rm_s Drive</a>. Enthusiast of 🎵🪀(Audiophile), curated with ❤️ by RansomwareKK.',
  ...
  email: 'mailto:me@RylondKuiperPienaar@outlook.co.nz',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Ransomliome360',
    },
  ],
